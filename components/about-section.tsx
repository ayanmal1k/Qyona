...
export default function AboutSection() {
  return (
    <section className="relative w-full bg-[#070114] overflow-hidden">
      {/* ========================================================================= */}
      ...
      <div className="relative w-full max-w-[1920px] mx-auto hidden md:flex md:flex-col md:aspect-[1920/1080] md:min-h-[720px] lg:min-h-[820px] xl:min-h-[960px] overflow-hidden">
        {/* DESKTOP BACKGROUND IMAGE (1920x1080) */}
        ...
        <div className="relative z-10 w-full h-[35%] flex items-center justify-center max-w-[1440px] mx-auto px-6 lg:px-10 xl:px-14 pt-6 md:pt-8 lg:pt-10">
          <motion.div
            ...
            className="w-full relative rounded-[22px] lg:rounded-[28px] overflow-hidden bg-[#0c0420]/65 backdrop-blur-xl border border-purple-500/35 shadow-[0_15px_40px_rgba(0,0,0,0.8),inset_0_1px_1px_rgba(255,255,255,0.2),0_0_35px_rgba(157,78,221,0.2)] before:absolute before:inset-x-0 before:top-0 before:h-px before:bg-gradient-to-r before:from-transparent before:via-purple-400/60 before:to-transparent"
          >
            <div className="grid grid-cols-4 divide-x divide-purple-500/20">
        ...
        <div className="relative z-10 w-full h-[65%] max-w-[1440px] mx-auto px-6 lg:px-10 xl:px-14 pb-8 lg:pb-14 flex items-center">
          <div className="w-full grid grid-cols-12 gap-6 items-center">
            ...
            <motion.div
              ...
              className="col-span-7 flex flex-col items-start text-left pl-2 lg:pl-6 xl:pl-10"
            >
              {/* Purple Label */}
      ...
      <div className="block md:hidden w-full bg-[#070114]">
        ...
        <div className="relative w-full overflow-hidden bg-[#070114] py-10 px-4 sm:px-6">
          ...
          <div className="relative z-10 w-full max-w-[500px] mx-auto">
            <motion.div
              ...
              className="relative rounded-[22px] overflow-hidden bg-[#0c0420]/75 backdrop-blur-xl border border-purple-500/35 divide-y divide-purple-500/20 shadow-[0_15px_35px_rgba(0,0,0,0.85),0_0_30px_rgba(157,78,221,0.2)]"
            >
              {features.map((feature, index) => (
                <motion.div
                  key={feature.title}
        ...
        <div className="relative w-full overflow-hidden bg-[#070114] min-h-[760px] sm:min-h-[850px] flex flex-col justify-start">
          ...
          {/* CONTENT AT TOP, BOTTOM 40% (PB-[40%] / PB-[380PX]) LEFT EMPTY FOR CHARACTER ARTWORK */}
          <div className="relative z-10 w-full px-6 sm:px-8 pt-10 sm:pt-14 pb-[40%] sm:pb-[400px] flex flex-col items-start text-left max-w-[480px] mx-auto">
            ...
            <motion.span
              ...
              className="font-spock font-bold text-xs sm:text-sm text-[#a855f7] tracking-[0.2em] uppercase drop-shadow-[0_0_15px_rgba(168,85,247,0.9)] mb-2"
            >
              ABOUT QYONA
            </motion.span>
            ...
            <motion.p
              ...
              className="font-sans font-normal text-xs sm:text-sm text-[#cbd5e1] leading-relaxed mb-3 drop-shadow-[0_2px_4px_rgba(0,0,0,0.9)]"
            >
              QYONA comes from a distant galaxy where energy is life. Now QYONA has found a new{' '}
              <span className="text-[#a855f7] font-medium drop-shadow-[0_0_10px_rgba(168,85,247,0.6)]">
                home
            ...
            <motion.p
              ...
              className="font-sans font-normal text-xs sm:text-sm text-[#cbd5e1] leading-relaxed drop-shadow-[0_2px_4px_rgba(0,0,0,0.9)]"
            >
              Help QYONA collect the energy of the community and become the brightest star in the universe.
            </motion.p>
          </div>
