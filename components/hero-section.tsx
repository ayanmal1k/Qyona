...
export default function HeroSection() {
  ...
  return (
    <section id="home" className="relative w-full min-h-[100dvh] md:min-h-0 md:aspect-[1920/1080] max-w-[1920px] mx-auto flex items-center justify-center bg-[#070114] overflow-hidden pt-16 md:pt-0">
      {/* ================= DESKTOP BACKGROUND WITH GSAP PARALLAX (1920x1080) ================= */}
      <GSAPParallax speed={0.12} className="absolute inset-0 hidden md:block select-none pointer-events-none z-0">
        <Image
      ...
      {/* ================= MOBILE BACKGROUND WITH GSAP PARALLAX (1080x1920 Proportions) ================= */}
      <GSAPParallax speed={0.12} className="absolute inset-0 block md:hidden select-none pointer-events-none z-0">
        <Image
