...
import { AnimatedSection, GSAPParallax } from '@/components/ui/animated-section'
  ...
  return (
    <section id="socials" className="relative w-full overflow-hidden bg-[#070114] py-14 sm:py-20 lg:py-24">
      ...
      <div className="relative z-10 w-full max-w-[1440px] mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <AnimatedSection direction="scale" amount={0.15} className="hidden md:block">
          <div className="relative w-full rounded-[28px] sm:rounded-[36px] overflow-hidden bg-[#0c0420]/80 backdrop-blur-2xl border border-purple-500/35 shadow-[0_25px_70px_rgba(0,0,0,0.85),inset_0_1px_1px_rgba(255,255,255,0.2),0_0_50px_rgba(157,78,221,0.25)] min-h-[340px] lg:min-h-[400px] xl:min-h-[440px] flex items-center before:absolute before:inset-x-0 before:top-0 before:h-px before:bg-gradient-to-r before:from-transparent before:via-purple-400/60 before:to-transparent">
            {/* DESKTOP BACKGROUND IMAGE WITH GSAP PARALLAX (/social-bg.avif) */}
        ...
        {/* ================= MOBILE VIEW (< MD) ================= */}
        <AnimatedSection direction="scale" amount={0.15} className="block md:hidden">
          <div className="relative w-full rounded-[28px] overflow-hidden bg-[#0c0420]/85 border border-purple-500/35 shadow-[0_20px_60px_rgba(0,0,0,0.85)] min-h-[620px] sm:min-h-[700px] flex flex-col justify-start">
            {/* MOBILE BACKGROUND IMAGE WITH GSAP PARALLAX (/social-bg-mobile.jpg) */}
            <GSAPParallax speed={0.1} className="absolute inset-0 select-none pointer-events-none z-0">
              <Image
